...
filename = "src/pyvider/protocols/tfprotov6/handlers/import_resource_state.py"
with open(filename, 'r') as f:
    content = f.read()

content = content.replace("from pyvider.exceptions import ResourceError", "from pyvider.exceptions import ResourceError, Deferral")
...
content = content.replace("    except Exception as e:", deferral_catch)
